...
/**
 * Helper class to store {@link Subscription}s and {@link }s in {@link SharedPreferences}.
 *
...
public final class SharedPreferencesHelper {
    ...
    private static final String PREFS_NAME = "com.android.exttv";
    private static final String PREFS_SUBSCRIPTIONS_KEY =
            "com.android.exttv.prefs.SUBSCRIPTIONS";
    private static final String PREFS_SUBSCRIBED_MOVIES_PREFIX =
            "com.android.exttv.prefs.SUBSCRIBED_MOVIES_";
    private static final String PREFS_SUBSCRIBED_PROGRAM_PREFIX =
            "com.android.exttv.prefs.SUBSCRIBED_PROGRAM_";
     ...
     *     objects exists.
     */
    public static <T> List<T> getList(Context context, Class<T> clazz, String key) {
     ...
     */
    public static <T> void setList(Context context, List<T> list, String key) {
        SharedPreferences sharedPreferences =
                context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE);
